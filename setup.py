...
try:
    ...
    subprocess.Popen(['wget', 'https://download.docker.com/linux/raspbian/dists/bullseye/pool/stable/armhf/containerd.io_1.6.9-1_armhf.deb', '-O', path+'/containerd.io_1.6.9-1_armhf.deb'])
    subprocess.Popen(['wget', 'https://download.docker.com/linux/raspbian/dists/bullseye/pool/stable/armhf/docker-ce_25.0.3-1~raspbian.11~bullseye_armhf.deb', '-O', path+'/docker-ce_25.0.3-1~raspbian.11~bullseye_armhf.deb'])
